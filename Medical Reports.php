...
<html>
    ...
    <link rel="stylesheet" href="Style_Medical_Recipt.css?v=<?php echo time(); ?>">
    ...
    <section class="A">
            ...
            <img src="WUSL_White_Logo.png" style="width:5cm;margin-left: -0.5cm;">
                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <li><a href="medical report history.php">History</a></li>
...
<h2 style="text-align:center;margin-top:2cm;">&nbsp;&nbsp;&nbsp;&nbsp; Medical Requested Form</h2>
        <div class="cont">
  ...
  <div class="row">
  <div class="col-25">
      <label for="indexno">  Reason </label>
    </div>
    <div class="col-75">
        <span id="genderArea">
        <input type="radio" name="Reason" class="radio" value="For Examination Purpose." checked>
        <label>For Examination Purpose. </label>
        &nbsp; &nbsp; &nbsp; &nbsp;
        <input type="radio" name="Reason" class="radio" value="For Mahapola/Bursary Purpose.">
        <label> For Mahapola/Bursary Purpose. </label>
        </span>
  ...
  <div class="row">
  <div class="col-25">
      <label for="indexno"> Duration  </label>
    </div>
    <div class="col-75">
    From &nbsp;<input type="date" id="time period" name="From">&nbsp; &nbsp; &nbsp; &nbsp;
    To &nbsp;<input type="date" id="time period" name="To">
</p>
    </div>
  </div>
  <div class="row">
  <div class="col-25">
      <label for="indexno"> Attachment  </label>
    </div>
    <div class="col-75">

...
$sql =" SELECT * FROM online_treatments ORDER BY Date DESC ";
//$sql ="SELECT * FROM online_treatments INNER JOIN appoinment_check ON online_treatments.T_id = appoinment_check.T_id ORDER BY online_treatments.Date DESC";
//execute the query
...
<head>
    ...
    <section class="A">
       ...
       <div class="table-responsive-xxl">
		...
		<h2 style="text-align:center;"> &nbsp;  Appoinment Requesed of Student</h2>
    <br>
        <br>
   ...
   <thead>
	...
	<tbody>	
		...
		?>
                    ...
                    <td><a class="btn btn-info" style="width: 2.5cm;" href="doctorcheck.php?T_id=<?php echo $row['T_id'];?>">Check</a></td>
                    </tr>	

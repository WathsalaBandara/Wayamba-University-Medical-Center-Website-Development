...
$sql = "SELECT * FROM  medical_recipt WHERE S_id ='$id' ";
...
<section class="A">
	...
	<div class="container">
        ...
        <h2 style="text-align:center;">Requsted History   </h2> <br>
        </div>
...
<table class="table">
	...
	<tbody>	
		...
		?>
					...
					<td><a class="btn btn-danger" style="width: 2.5cm;" href="delete medical report.php?Recipt_No=<?php echo $row['Recipt_No']; ?>">Delete</a></td>
					</tr>	
